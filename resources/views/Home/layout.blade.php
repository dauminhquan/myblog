...
<html>
<head>
    <title>Tìm kiếm nguồn vui mới | Home :: Tuhuso.com </title>
...
<div class="technology">
    <div class="container" id="container-vue">
        @section("container")
        @show
...
<div class="footer">
    <div class="container">
        <div class="col-md-4 footer-left wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
            ...
            <div class="bht1">
                <a href="singlepage.html">Đọc thêm</a>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        $("#link-effect-7 li a[href=\""+window.location.href+"\"]").parents("li:eq(0)").addClass("active act")
    })
</script>
</body>
</html>